...
```{r make.sun.data, echo=F}
make.sun.data <- function(filter, vision, vision.type, sun) {
...
Calculate flux for visual observing of sunlit object
```{r}
sun.data <- rbind(
  make.sun.data(filter, vision, "Scotopic", sun), 
  make.sun.data(filter, vision, "Photopic", sun)
)
...
Calculate flux and contrast for visual observing Jupiter
```{r}
jupiter.data <- rbind(
